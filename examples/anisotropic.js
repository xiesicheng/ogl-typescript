...
`
    ...
    resize();
    const scene = new Transform(); // By default, anisotropy is not active

    const texture = new Texture(gl); // Pass in number of anisotropic samples to activate

    const textureAnisotropy = new Texture(gl, {
      anisotropy: 16
    });
    const img = new Image();
