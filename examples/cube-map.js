...
`
    ...
    resize();
    const scene = new Transform(); // Create an empty texture using the gl.TEXTURE_CUBE_MAP target
    ...
    async function loadImages() {
      ...
      const images = await Promise.all([loadImage('assets/cube/posx.jpg'), loadImage('assets/cube/negx.jpg'), loadImage('assets/cube/posy.jpg'), loadImage('assets/cube/negy.jpg'), loadImage('assets/cube/posz.jpg'), loadImage('assets/cube/negz.jpg')]); // Once all are loaded, we can update the texture image, which will upload them
