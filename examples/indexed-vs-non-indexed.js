...
`
    ...
    resize();
    const scene = new Transform(); // 4 vertices, using 6 indices to designate 2 triangles using the default gl.TRIANGLES draw mode

    const indexedGeometry = new Geometry(gl, {
      position: {
        size: 3,
        data: new Float32Array([-0.5, 0.5, 0, // vertex 0
        -0.5, -0.5, 0, // vertex 1
        0.5, 0.5, 0, // vertex 2
        0.5, -0.5, 0 // vertex 3
        ])
      ...
      uv: {
        size: 2,
        data: new Float32Array([0, 1, // vertex 0
        1, 1, // vertex 1
        0, 0, // vertex 2
        1, 0 // vertex 3
        ])
    ...
    const indexedMesh = new Mesh(gl, {
      geometry: indexedGeometry,
      program
    });
    indexedMesh.setParent(scene);
    indexedMesh.position.y = 0.9;
    const nonIndexedMesh = new Mesh(gl, {
