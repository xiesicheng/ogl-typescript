...
void main() ${`{`}
  ...
  FragColor.a = alpha * uAlpha;
    ...
    };
    {
      ...
      const controls = new Orbit(camera); // controls.target.y = 25;
      ...
      let gltf; // Common textures for uber shader
      ...
      function addGLTF(gltf) {
        ...
        scene.updateMatrixWorld(); // Calculate rough world bounds to update camera
        ...
        gltf.meshes.forEach(group => {
          group.primitives.forEach(mesh => {
            ...
            boundsCenter.copy(mesh.geometry.bounds.center).applyMatrix4(mesh.worldMatrix); // Get max world scale axis
            ...
            boundsMax.set(+radius).add(boundsCenter); // Apply world matrix to bounds
      ...
      function createProgram(node) {
        ...
        const program = new Program(gl, {
          ...
          uniforms: {
            uBaseColorFactor: {
              value: gltf.baseColorFactor || [1, 1, 1, 1]
            },
            tBaseColor: {
              value: gltf.baseColorTexture ? gltf.baseColorTexture.texture : null
            },
            tRM: {
              value: gltf.metallicRoughnessTexture ? gltf.metallicRoughnessTexture.texture : null
            },
            uRoughness: {
              value: gltf.roughnessFactor !== undefined ? gltf.roughnessFactor : 1
            },
            uMetallic: {
              value: gltf.metallicFactor !== undefined ? gltf.metallicFactor : 1
            },
            tNormal: {
              value: gltf.normalTexture ? gltf.normalTexture.texture : null
            },
            uNormalScale: {
              value: gltf.normalTexture ? gltf.normalTexture.scale || 1 : 1
            },
            tOcclusion: {
              value: gltf.occlusionTexture ? gltf.occlusionTexture.texture : null
            },
            tEmissive: {
              value: gltf.emissiveTexture ? gltf.emissiveTexture.texture : null
            },
            uEmissive: {
              value: gltf.emissiveFactor || [0, 0, 0]
            },
            tLUT: {
              value: lutTexture
            },
