...
`
  ...
  function update(t) {
    requestAnimationFrame(update); // add some slight overall movement to be more interesting
  ...
  document.getElementsByClassName('Info')[0].innerHTML = 'Particles';
  document.title = 'OGL • Particles';
