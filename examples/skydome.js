...
`
    ...
    resize();
    const scene = new Transform(); // Texture is equirectangular
    ...
    img.src = 'assets/sky.jpg'; // Use Sphere geometry to render equirectangular textures
    ...
    mesh.setParent(scene); // Camera will dwell inside skybox
